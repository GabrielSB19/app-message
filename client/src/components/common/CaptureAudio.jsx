...
function CaptureAudio({ hide }) {
  ...
  useEffect(() => {
    console.log("waveformRef", waveformRef.current);
  ...
  const handleStartRecording = () => {
    ...
    navigator.mediaDevices
      ...
      .then((stream) => {
        const mediaRecorded = new MediaRecorder(stream);
        mediaRecorderRef.current = mediaRecorded;
        audioRef.current.srcObject = stream;
        const chunks = [];
        mediaRecorded.ondataavailable = (e) => chunks.push(e.data);
      ...
      .catch((err) => {
        console.log("Error accessing michopone", err);
      });
  };
